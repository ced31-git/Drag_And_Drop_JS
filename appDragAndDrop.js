...
base.style.backgroundImage = `url(https://loremflickr.com/320/240/truck?random=${indexPhoto})`;
photoEnCours = `url(https://loremflickr.com/320/240/truck?random=${indexPhoto})`;
...
function nvBase() {
  ...
  indexPhoto++;
  newBase.style.backgroundImage = `url(https://loremflickr.com/320/240/truck?random=${indexPhoto})`;
  photoEnCours = `url(https://loremflickr.com/320/240/truck?random=${indexPhoto})`;
